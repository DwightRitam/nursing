...
<section className="dark:bg-gray-800 dark:text-gray-100 herobg object-top">
	<div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
		...
		<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
			<h1 className="text-3xl font-bold leading-none sm:text-6xl text-white ">Check up your close ones  in  <br/> Doctorz <span className='text-slate-600'>Club </span> 
			</h1>
			<p className="mt-6 mb-8 text-2xl sm:mb-12 text-white opacity-75">Always here for you
