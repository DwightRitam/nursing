...
const contact = () => {
  return (
    <>
    <section className="pt-[2.5rem] contactbg pb-[2.5rem]  m-auto   dark:bg-gray-800 dark:text-gray-50">
        <h2 className='text-center text-3xl  mb-[20px] font-semibold'>Contact us for any kind of information</h2>
<hr className='w-[80%] mb-[20px] m-auto'/>
	...
	<div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
		...
		<form novalidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
			...
			<button type="button" className="self-center border border-slate-500 px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 dark:bg-violet-400 dark:text-gray-900 focus:ring-violet-400 hover:ring-violet-400">Submit</button>
		</form>
	</div>
</section>
</>
