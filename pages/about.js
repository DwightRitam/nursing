...
const about = () => {
  return (
    <>
        <h2 className='text-3xl text-center pt-3'>About us </h2>
        <hr className='w-[80%] m-auto'/> <br/>
       <hr className='w-[50%] m-auto pb-[25px]'/>

    <section class=" dark:bg-gray-900">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <img class="w-full dark:hidden" src="https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="dashboard image"/>
